...
namespace TechnologicalUI
{
    public class Presenter
    {
        ...
        public BL.User LogIn(string login, string password)
        {
            ...
            {
                throw new AdminPermissionsException("Acsess permissions are missing.");
            }
        ...
        public BL.User LogOut(string login)
        {
        ...
        public int UpdateUser(int id, BL.User newUser)
        {
            if (AccessPermissions == Permissions.UNAUTHORIZED) 
            {
                throw new UnauthorizedPermissionsException("Acsess permissions are missing.");
            }
        ...
        public List<BL.Coming> GetComings(int offset = 0, int limit = -1)
        {
            ...
            {
                throw new AnalystPermissionsException("Acsess permissions are missing.");
            }
            else
            {
        ...
        {
            if (AccessPermissions != Permissions.ANALYST && AccessPermissions != Permissions.EMPLOYEE)
            {
                throw new AnalystPermissionsException("Acsess permissions are missing.");
            }
        ...
        public int AddComing(BL.Coming com)
        {
            if (AccessPermissions != Permissions.EMPLOYEE)
            {
                throw new EmployeePermissionsException("Acsess permissions are missing.");
            }

            return Facade.AddComing(com);
        }
        ...
        public int AddDeparture(BL.Departure dep)
        {
            if (AccessPermissions != Permissions.EMPLOYEE)
            {
                throw new EmployeePermissionsException("Acsess permissions are missing.");
            ...
            return Facade.AddDeparture(dep);
        }
